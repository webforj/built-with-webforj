...
/**
 * Data initializer that loads initial data into the database on application
 * startup.
 * 
 * @Component - Makes this a Spring-managed bean
 * @Transactional - Ensures all database operations happen in a single
 *                transaction
 * 
 *                The constructor runs automatically when Spring creates this
 *                component,
