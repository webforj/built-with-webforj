...
```properties
# Application name
spring.application.name=webforj-spring-security
...
java -jar target/webforj-spring-security-1.0-SNAPSHOT.jar
```
...
docker run -p 8080:8080 webforj-spring-security:1.0-SNAPSHOT

# Or run with environment variables
docker run -p 8080:8080 -e SPRING_PROFILES_ACTIVE=prod webforj-spring-security:1.0-SNAPSHOT
```
