...
public class FilterBar extends Composite<Div> {
  ...
  public FilterBar() {
    ...
    Div filtersWrapper = new Div();
    filtersWrapper.addClassName("filter-bar__filters-wrapper");
    filtersWrapper.add(createFilters(), chipsRow);
  ...
  private Div createFilters() {
    ...
    searchField.addClassName("filter-bar__search");
    ...
    filters.add(searchField, typeChoice, bedsChoice, bathsChoice);
    return filters;
  }
