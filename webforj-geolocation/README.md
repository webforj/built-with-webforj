...
```properties
# Application name
spring.application.name=webforj-geolocation
...
java -jar target/webforj-geolocation-1.0-SNAPSHOT.jar
```
...
docker run -p 8080:8080 webforj-geolocation:1.0-SNAPSHOT

# Or run with environment variables
docker run -p 8080:8080 -e SPRING_PROFILES_ACTIVE=prod webforj-geolocation:1.0-SNAPSHOT
```
