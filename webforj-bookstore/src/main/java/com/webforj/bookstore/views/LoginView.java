...
public class LoginView extends Composite<Login> implements DidEnterObserver {
  ...
  public LoginView() {
    ...
    // Show test credentials as a hint before any login attempt
    Paragraph hint = new Paragraph("Test credentials: admin/admin or user/password");
    self.addToBeforeForm(hint);
